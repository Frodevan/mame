...
class device_tandberg_tdv2100_card_interface : public device_interface
{
	...
	protected:
		...
		tandberg_tdv2100_bus_slot_device *m_slot;
};
...
class tandberg_tdv2100_bus_device : public device_t, public device_memory_interface
{
	public:
	...
	private:
		...
		const address_space_config m_space_mem_config;
		const address_space_config m_space_io_config;
